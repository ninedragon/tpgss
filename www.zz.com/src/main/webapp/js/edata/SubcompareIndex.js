...
$(function () {  
    ...
    {  
        ...
        cParaid = $('#cParaid').val(),
        pathSave = $("#pathSave").val();
        $.post('getV52.shtml',{cDistrictbcdid:row.C_DistrictBCDId,cChannelid:row.C_ChannelId,cAddressid:row.C_AddressId,cRecorddatebcd:row.C_RecordDateBCD,jump:row.C_JumpSecond,cParaid:cParaid,startPoint:startPoint,endPoint:endPoint,rootPath:rootPath,pathSave:pathSave},function(data1){
            drawChart(data1); 
