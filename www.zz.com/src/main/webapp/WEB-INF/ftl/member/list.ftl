						...
						<#if page?exists && page.list?size gt 0 >
							<#list page.list as it>
								<tr>
									...
									<#-- <td>${it.meter?default('未设置')}</td>
									<td>${it.supply?default('未设置')}</td>
									<td>${it.location?default('未设置')}</td>
									<td>${it.housenum?default('未设置')}</td>
									<td>${it.sim?default('未设置')}</td>
									<td>${it.absid?default('未设置')}</td>
									<td>${it.version?default('未设置')}</td> -->
									<td>
										<@shiro.hasPermission name="/member/forbidUserById.shtml">
