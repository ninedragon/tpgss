			                ...
			                if (page != null ) {
			                    ...
			                    if (epuList!=null && epuList.length>0) {
			                        ...
			                        for (var i = 0; i < epuList.length; i++) {
			                            ...
			                            tbody += '&nbsp;&nbsp; <a href="javascript:epuMark(\''+epuList[i].rowId+'\',\''+epuXscale+'\',\''+epuYscale+'\',\''+epuLocal+'\');">位置</a></div></td>';
			                            ...
			                            tbody += '<td><div>' + epuList[i].epuLocal + '</div></td>';
			                            
			                            tbody += '<td><div>' + epuList[i].epuName+ '</div></td>';
			                            tbody += '<td><div>' + epuList[i].epuTypeName + '</div></td>';
			                            tbody += '<td><div>' +epuList[i].epuParentName + '</div></td>';
	...
	<body data-target="#one" data-spy="scroll">
		...
		<div class="container" style="padding-bottom: 15px;min-height: 300px; margin-top: 40px;">
			...
			<div class="search">
				...
				<div class="mode">设备类型
					<span>:</span><select
						name="epuType" id="epuType">
					</select>
				</div>
				<div class="mode">设备名称 
					<span>:</span>
					<input name="epuName" type="text" class="text" id="epuName">
				</div>
				...
				<div class="but02" style="text-align: center;">
					...
					<a href="${basePath}/epu/add.shtml"class="but02"  id="butadd" >新增</a>
				</div>
			</div>
