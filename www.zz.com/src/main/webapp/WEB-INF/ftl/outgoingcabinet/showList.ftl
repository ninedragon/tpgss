			 ...
			 so.delEpuInfo=function delEpuInfo(rowId) {				
				if(confirm('确实要删除该内容吗?')){
	   				 ...
	   				 $.ajax({
	   		  			    ...
	   		  			    type:'POST',
	   		  			    dataType:'json',
	   		  			    data:{rowId:rowId,epuType:'M0002'},
	   		  			    success:function(data){
	   		  			    	...
	   		  			    	$("#loadingDiv").hide();
	   		  					 ...
	   		  					 window.location="${basePath}/epu/showOutgoingcabinetList.shtml";
	   		  			    	$("#loadingDiv").hide();
	   		  			    	}
	   		  			    }
...
<div class="wapp-layer"  id="saveDiv">
	...
	<h4><div id='epuTitle'>新增出线柜</div><span class="close-js"  onclick="$('#saveDiv').hide();">关闭</span></h4>
        ...
        <div class="edit" style="height:auto">
            ...
            <lable>
             ...
             <lable>
                ...
                <select name="addressId" id="addressId" class="text requiredSelect" title="BDTU终端地址号">
								</select>
            </lable>
             <lable>
                 <span style="width:115px;">BDTU终端通道数</span>
