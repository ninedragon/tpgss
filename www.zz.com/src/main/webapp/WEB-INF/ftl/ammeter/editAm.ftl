		        	  ...
		        	  $.ajax({
			                ...
			                success: function (a) {
			                    ...
			                    for (var i = 0; i < epuParentList.length; i++) {
			                    	if(epuId==epuParentList[i].epuId)
   			                    	{
			                        $('#epuId').append('<option value="' + epuParentList[i].epuId + '" selected="selected">' + epuParentList[i].epuName + '</option>');
   			                    	}
			                    	else
			                    	{
			...
			<div class="row">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="edit-wapper">					
					...
					<tr>
						...
						<td >
							<div class="mode"><input name="ammeterName" id="ammeterName" value="${epuInfo.ammeterName}"  type="text" class="text request" title="电表名称" maxlength="100"></div>
						</td>
						   <td >
						...
						<td >							
							<div class="mode"><input name="ammeterId"  id="ammeterId"  value="${epuInfo.ammeterId}" type="text" class="text request" title="电表号" maxlength="100">
                   ...
                   <tr >						
						...
						<td >
							<div class="mode">
							<input name="houseId"  id="houseId"  value="${epuInfo.houseId}" type="text" class="text request" title="门牌号" maxlength="100">
						...
						<td >
							<div class="mode">
							<input name="phaseRemark"  id="phaseRemark"  value="${epuInfo.phaseRemark}"  type="text" class="text request" title="相别" maxlength="100">
