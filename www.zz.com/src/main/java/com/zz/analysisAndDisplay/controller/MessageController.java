...
public class MessageController extends BaseController {
    ...
    public static Object data = "event did not occur";
    ...
    private void listen() {
        //【1】开启线程监听事件,在循环前面拿userSocket又拿不到，可能还没执行完onopen方法
                ...
                try {
                    ...
                    for (String key : userSocket.keySet()) {
                        if (userList.contains(key)) {
                            System.out.println("the key already has been added");
                        } else {
                            userList.add(key);
                    ...
                    for (int i = 0; i < userList.size(); i++) {
                        ...
                        if (wsMessageService.sendToAllTerminal(user, JsonUtil.jsonObj2Sting(data))) {
