...
import com.zz.common.utils.SerializeUtil;
 ...
 *
 * @author jqs
 * @email  908072950@qq.com
 * @version 1.0,2017年12月28日 <br/>
 * 
 */
    ...
    public Jedis getJedis() {
        ...
        try {
        	...
        	if("Could not get a resource from the pool".equalsIgnoreCase(message)){
        		...
        		System.out.println("|①.请检查是否安装redis服务，如果没安装，Windos 请参考Blog：http://www.zz.com/blog/110.html|");
        		...
        		System.out.println("|④.免费的方案请参考链接：http://www.zz.com/shiro");
        		
        		System.out.println("|PS.如果对Redis表示排斥，请使用Ehcache版本：http://www.zz.com/jc_shiro_ssm_ehcache.html");
