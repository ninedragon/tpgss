package com.zz.bdtu.controller;
...
@RequestMapping("bDtu")
public class BdtuController extends BaseController {
	...
	@Autowired
	BdtuService dtuService;

	@RequestMapping(value="showDtuList")
	public ModelAndView showDtuList(ModelMap map){	
		
		ModelAndView modelAndView = new  ModelAndView("woodare/dtu/showBdtuList");
