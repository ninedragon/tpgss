...
public class HttpsUtil extends DefaultHttpClient {
	...
	public void initSSLConfigForTwoWay() throws Exception {
		...
		String rootpath=Thread.currentThread().getContextClassLoader().getResource("").toURI().toString().substring(6);
		rootpath=rootpath.substring(0,rootpath.lastIndexOf("/"));
    	rootpath=rootpath.substring(0,rootpath.lastIndexOf("/") );
    	rootpath=rootpath.substring(0,rootpath.lastIndexOf("/") );
		String selfcertpath = rootpath + Constant.SELFCERTPATH;
		String trustcapath = rootpath + Constant.TRUSTCAPATH;
