package com.zz.deviceAndData.service.na.service.dataCollection;
...
public class SubscribeNotification {
    ...
    public  Map<String, Object> subscribeNotification(String callbackBaseUrl) throws Exception {
        ...
        System.out.println("回调url为"+callbackurl_deviceDataChanged);
        return msgmap;
