 ...
 */
package com.zz.deviceAndData.service.na.utils;
...
public class Constant {
    ...
    public static final String APPID = "Qrs_gHqSUVwnNpKdXONDFLDdaq8a";
    public static final String SECRET = "4m_85EhucLpvDssfCP7aCfRd_twa";
...
//    public static final String DEVICE_ADDED_CALLBACK_URL = CALLBACK_BASE_URL + "/na/iocm/devNotify/v1.1.0/addDevice";
    public static final String DEVICE_ADDED_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/registerDevice";
    public static final String DEVICE_INFO_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/updateDeviceInfo";
//    public static final String DEVICE_DATA_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/updateDeviceData";//公司原有服务器
    public static final String DEVICE_DATA_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/updateDeviceData";
    public static final String DEVICE_DELETED_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/deletedDevice";
    public static final String MESSAGE_CONFIRM_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/commandConfirmData";
    public static final String SERVICE_INFO_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/updateServiceInfo";
    public static final String COMMAND_RSP_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/commandRspData";
    public static final String DEVICE_EVENT_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/DeviceEvent";
    public static final String RULE_EVENT_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/RulEevent";
    public static final String DEVICE_DATAS_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/zz/fetch/updateDeviceDatas";
...
//    public static final String DEVICE_DATAS_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/na/iocm/devNotify/v1.1.0/updateDeviceDatas";
    ...
    public static String SELFCERTPATH = "/resource/cert/outgoing.CertwithKey.pkcs12";
    public static String TRUSTCAPATH = "/resource/cert/ca.jks";
    ...
    public static final String SendCmd = BASE_URL+"/iocm/app/signaltrans/v1.1.0/devices/%s/services/%s/sendCommand";
