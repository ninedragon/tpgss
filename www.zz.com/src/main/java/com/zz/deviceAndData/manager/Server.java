package com.zz.deviceAndData.manager;
...
import com.zz.deviceAndData.utils.SocketRequest;  
    ...
    class ServerThread extends Thread {  
        ...
        public ServerThread(Socket s) throws IOException {  
        	...
        	SocketRequest request = new SocketRequest(socket  
                    .getInputStream()); //socket为ServerSocket.accept()返回的Socket实例  
        	 request.ReadData(); //读取数据  
        	 String data = request.getData(); 
        	 System.out.println("data是:");
        	System.out.println(data);//以后可注掉
