 ...
 */
package com.zz.edata.service.na.utils;
...
public class Constant {
    ...
    public static final String APPID = "PY59f7Da6_d7UIu5OdEx2y5ShIAa";
    public static final String SECRET = "hr1ctVQY7mHHqp7vQ6H6bhFzNZMa";
     ...
     */
    public static final String CALLBACK_BASE_URL = "http://122.112.227.234:8080";
...
//    public static final String DEVICE_ADDED_CALLBACK_URL = CALLBACK_BASE_URL + "/na/iocm/devNotify/v1.1.0/addDevice";
    public static final String DEVICE_ADDED_CALLBACK_URL = CALLBACK_BASE_URL + "/registerDevice";
