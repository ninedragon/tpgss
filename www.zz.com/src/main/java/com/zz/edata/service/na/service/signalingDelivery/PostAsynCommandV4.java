 ...
 */
package com.zz.edata.service.na.service.signalingDelivery;
...
public class PostAsynCommandV4 {
    ...
    public  Map<String, Object> postAsynCommandV4(String indicateCmd) throws Exception {//设计为返回map是为了便于提供需要信息
        /*
...
//  }
        ...
        String deviceId = "fd90017b-9d2d-4ecc-984f-beda9c0c732e";
...
//        ObjectNode paras = JsonUtil.convertObject2ObjectNode("{\"msgType\":\"cloudReq\",\"serviceId\":\"IndicateCmd\",\"mid\":2016,\"cmd\":\"DELIVER_DEVICE_CMD\",\"paras\":{\"indicateCmd\":1234},\"hasMore\":0}}");//AT+NMGS=5,00012E1F63
        ObjectNode paras = JsonUtil.convertObject2ObjectNode("{\"indicateCmd\":\""+indicateCmd+"\"}");
...
//        String content = JsonUtil.jsonObj2Sting(params);
    ...
    public static void main(String[] args) throws Exception {
    	new PostAsynCommandV4().postAsynCommandV4("123");
    }
