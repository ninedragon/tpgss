...
public class CCRDFile {
	...
	public static void main(String[] args) {
		...
		String dirName = "I:" + File.separator + "录波数据算法"+File.separator+"04120048-17-08-28-13-06-17";// 创建目录
		cf.createDir(dirName);// 调用方法创建目录
		String fileName = dirName + File.separator+"file1.txt";// 创建文件
		cf.createFile(fileName);// 调用方法创建文件
		cf.deleteFolder(dirName);
