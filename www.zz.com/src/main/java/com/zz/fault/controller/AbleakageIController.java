...
@RequestMapping("ableakageI")
public class AbleakageIController extends BaseController{
	@Autowired
	AbleakageIService ableakageIService;
	/**
	 * 查询列表管理
	 * @return
	 */
	...
	public @ResponseBody Map<String,Object> queryList(Integer pageNo,Integer pageSize,HttpServletRequest request,ModelMap map) {
		...
		Pagination<AbleakageI> page = ableakageIService.findByPage(map,pageNo,pageSize);
