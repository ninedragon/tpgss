...
@RequestMapping("shortI")
public class ShortIController extends BaseController{
	@Autowired
	ShortIService shortIService;
	/**
	 * 查询列表管理
	 * @return
	 */
	...
	public @ResponseBody Map<String,Object> queryList(Integer pageNo,Integer pageSize,HttpServletRequest request,ModelMap map) {
		...
		Pagination<ShortI> page = shortIService.findByPage(map,pageNo,pageSize);
