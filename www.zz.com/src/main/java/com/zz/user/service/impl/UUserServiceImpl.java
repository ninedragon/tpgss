...
import com.zz.common.dao.UUserMapper;
import com.zz.common.dao.UUserRoleMapper;
import com.zz.common.model.UUser;
import com.zz.common.model.UUserRole;
...
public class UUserServiceImpl extends BaseMybatisDao<UUserMapper> implements UUserService {
	...
	@Override
	public List<HashMap<String, Object>> findUsersBy(UUser entity) {
		return userMapper.selectUsersBy(entity);
	}

	@Override
	public Integer findUsersByCount(UUser entity) {
	
		System.out.println(entity.getStatus());
		System.out.println(entity.getStatus()==null);
		
		return userMapper.selectUsersByCount(entity);
	}
